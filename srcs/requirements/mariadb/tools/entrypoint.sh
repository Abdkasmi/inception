...
mysql -u root -e "CREATE USER '${MARIADB_USER}'@'%' IDENTIFIED WITH mysql_native_password BY '${MARIADB_USER_PASSWORD}';"
mysql -u root -e "GRANT ALL PRIVILEGES ON *.* TO '${MARIADB_USER}'@'%'; FLUSH PRIVILEGES;"
